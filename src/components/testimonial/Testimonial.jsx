...
const Testimonial = ({ limit = 3 }) => {
    const { testimonials, calculateAverageRating } = useContext(MyContext);
    ...
    return (
        <Container maxWidth="lg" sx={{ py: 8 }}>
                ...
                {randomTestimonials.map((testimonial, index) => (
                    ...
                    >
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            <Avatar 
                                src={testimonial.isAnonymous ? '' : testimonial.photoURL} 
                            />
                            <Box>
            ...
            <Box sx={{ 
                ...
                >
                    See {testimonials?.length || 0}+ reviews
                </Button>
            </Box>
